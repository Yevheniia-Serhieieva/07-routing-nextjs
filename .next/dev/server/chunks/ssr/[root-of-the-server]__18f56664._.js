...
const createNote = async (note)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post(`/notes`, note, {
        headers: {
...
const NoteDetails = async ({ params })=>{
    ...
    await queryClient.prefetchQuery({
        ...
        queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getNotes"])(1, 12, undefined, tag)
    });
