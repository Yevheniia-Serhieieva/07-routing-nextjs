...
function Modal(t0) {
    ...
    if ($[0] !== "474f197666a8b1e65abe98b46f8a1c8637a47f38380bf326e8608e2b80e326db") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "474f197666a8b1e65abe98b46f8a1c8637a47f38380bf326e8608e2b80e326db";
    }
...
const createNote = async (note)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/notes`, note, {
        headers: {
...
function NoteForm(t0) {
    ...
    if ($[0] !== "c187f48642c5eeed53fb8707ece07aff467f13c84eec300068f005b00852531d") {
        for(let $i = 0; $i < 51; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c187f48642c5eeed53fb8707ece07aff467f13c84eec300068f005b00852531d";
    }
    const { onCancel, onSubmit } = t0;
    ...
    let t2;
    if ($[2] !== mutation || $[3] !== onCancel || $[4] !== onSubmit || $[5] !== queryClient) {
        t2 = ({
...
function _temp(values) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNote"])(values);
}
var _c;
...
function useDebounce(value, delay) {
    ...
    if ($[0] !== "1b660885edffa5c7ddb28db22044ac3b5fd21af937b805bf1da985129b6385ff") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1b660885edffa5c7ddb28db22044ac3b5fd21af937b805bf1da985129b6385ff";
    }
...
function Notes(t0) {
    ...
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"])();
    let t1;
    if ($[1] !== currentPage || $[2] !== debouncedSearch || $[3] !== tag) {
        t1 = {
            queryKey: [
                "notes",
                {
            ...
            queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNotes"])(currentPage, 12, debouncedSearch, tag),
    ...
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = ({
            "Notes[handlePageChange]": (page)=>{
                setCurrentPage(page);
            }
        })["Notes[handlePageChange]"];
        $[7] = t3;
    } else {
        t3 = $[7];
    }
    ...
    if ($[8] !== queryClient) {
        t4 = ({
            "Notes[handleCreateNote]": async (note)=>{
                ...
                try {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Failed to create note");
                }
            }
    ...
    const t5 = tag ? `Notes: '${tag}'` : "All notes";
    let t6;
    if ($[12] !== t5) {
    ...
    if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
        t7 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            onClick: {
                "Notes[<button>.onClick]": ()=>setIsModalOpen(true)
    ...
    let t11;
    if ($[20] !== currentPage || $[21] !== totalPages) {
    ...
    let t12;
    if ($[23] !== handleCreateNote || $[24] !== isModalOpen) {
        t12 = isModalOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Modal$2f$Modal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$NoteForm$2f$NoteForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                onCancel: {
                    "Notes[<NoteForm>.onCancel]": ()=>setIsModalOpen(false)
                }["Notes[<NoteForm>.onCancel]"]
            }, void 0, false, {
                fileName: "[project]/app/notes/filter/[...slug]/Notes.client.tsx",
                lineNumber: 218,
                columnNumber: 33
    ...
    let t13;
    if ($[26] !== t10 || $[27] !== t11 || $[28] !== t12 || $[29] !== t6 || $[30] !== t9) {
...
_s1(Notes, "6+JDsQA7XffrerAdUxbrc0GPj5U=", false, function() {
    return [
        useDebounce,
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"],
...
//# sourceMappingURL=_4279c6f9._.js.map